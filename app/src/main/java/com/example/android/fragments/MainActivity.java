...
// FragmentActivity - Base class for activities that want to use the support-based Fragment.
public class MainActivity extends FragmentActivity
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // FrameLayout. If so, we must add the headlines fragment.
    if (findViewById(R.id.fragment_container) != null) {
      ...
      // 1. setArguments - Supply the construction arguments for this fragment. This can only
      // be called before the fragment has been attached to its activity.
      // 2. getIntent - Return the intent that started this activity.
      // 3. getExtras - Retrieves a map of extended data from the intent.
  ...
  public void onArticleSelected(int position) {
    ...
    if (articleFrag != null) {
      ...
      // addToBackStack - Add this transaction to the back stack. This means that the
      // transaction will be remembered after it is committed, and will reverse its operation
